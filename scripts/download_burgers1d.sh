...
# Usage: bash ./scripts/download_darcy2d.sh
...
FILE_ID="16a8od4vidbiNR3WtaBPCSZ0T3moxjhYe"   # Replace with your file ID
OUTPUT="${REPO_ROOT}/src/datasets/Burgers1D/burgers.zip"
OUT_DIR="$(dirname "$OUTPUT")"
MAT="${OUT_DIR}/burgers_data_R10.mat"
COOKIES="${OUT_DIR}/.burgers_cookies.txt"
RESPONSE_HTML="${OUT_DIR}/.burgers_response.html"
